# Quiz) tkinter 를 활용한 메모장 프로그램을 만드시오.

# [GUI 조건]
# 1. title : 제목 없음 - window 메모장
# 2. 메뉴 : 파일, 편집, 서식, 보기, 도움말
# 3. 실제 메뉴 구현 : 파일 메뉴 내에서 열기, 저장, 끝내기 3개만 처리 
# 3-1. 열기 : mynote.txt 파일 내용 열여서 보여주기 
...
def ope_file():
  if os.path.isfile(filename): # 파일 있으면 True, 없으면 False 리턴
...
menu_file.add_command(label="열기", command=ope_file)
